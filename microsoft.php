		...
		?>
			...
			<div class="container">
				...
				<div class="history">
					...
					<p>Childhood friends Paul Allen and Bill Gates sought to make a successful business utilizing their shared skills in computer programming.[15] In 1972 they founded their first company, named Traf-O-Data, which sold a rudimentary computer to track and analyze automobile traffic data. While Gates enrolled at Harvard, Allen pursued a degree in computer science at Washington State University, though he later dropped out of school to work at Honeywell.[16] The January 1975 issue of Popular Electronics featured Micro Instrumentation and Telemetry Systems's (MITS) Altair 8800 microcomputer,[17] which inspired Allen to suggest that they could program a BASIC interpreter for the device. After a call from Gates claiming to have a working interpreter, MITS requested a demonstration. Since they didn't yet have one, Allen worked on a simulator for the Altair while Gates developed the interpreter. Although they developed the interpreter on a simulator and not the actual device, it worked flawlessly when they (in March 1975) demonstrated the interpreter to MITS in Albuquerque, New Mexico. MITS agreed to distribute it, marketing it as Altair BASIC.[14]:108, 112–114 Gates and Allen officially established Microsoft on April 4, 1975, with Gates as the CEO.[18] The original name of "Micro-Soft" was suggested by Allen.[19][20] In August 1977 the company formed an agreement with ASCII Magazine in Japan, resulting in its first international office, "ASCII Microsoft".[21] Microsoft moved to a new home in Bellevue, Washington in January 1979.</p>

					<p>Microsoft entered the operating system (OS) business in 1980 with its own version of Unix, called Xenix.[22] However, it was MS-DOS that solidified the company's dominance. After negotiations with Digital Research failed, IBM awarded a contract to Microsoft in November 1980 to provide a version of the CP/M OS, which was set to be used in the upcoming IBM Personal Computer (IBM PC).[23] For this deal, Microsoft purchased a CP/M clone called 86-DOS from Seattle Computer Products, which it branded as MS-DOS, though IBM rebranded it to PC DOS. Following the release of the IBM PC in August 1981, Microsoft retained ownership of MS-DOS. Since IBM had copyrighted the IBM PC BIOS, other companies had to reverse engineer it in order for non-IBM hardware to run as IBM PC compatibles, but no such restriction applied to the operating systems. Due to various factors, such as MS-DOS's available software selection, Microsoft eventually became the leading PC operating systems vendor.[24][25]:210 The company expanded into new markets with the release of the Microsoft Mouse in 1983, as well as with a publishing division named Microsoft Press.[14]:232 Paul Allen resigned from Microsoft in 1983 after developing Hodgkin's disease.[26] Allen claimed that Gates wanted to dilute his share in the company when he was diagnosed with Hodgkin’s disease because he didn’t think he was working hard enough.[27] After leaving Microsoft, Allen lost billions of dollars on ill-conceived or mistimed technology investments. He later invested in low-tech sectors, sports teams, and commercial real estate.</p>

					<h3>Windows and Microsoft Office</h3>

					<p>Despite having begun jointly developing a new operating system, OS/2, with IBM in August 1985,[29] Microsoft released Microsoft Windows, a graphical extension for MS-DOS, on November 20.[14]:242–243, 246 Microsoft moved its headquarters to Redmond on February 26, 1986, and on March 13 went public,[30] with the resulting rise in stock making an estimated four billionaires and 12,000 millionaires from Microsoft employees.[31] Microsoft released its version of OS/2 to original equipment manufacturers (OEMs) on April 2, 1987.[14] In 1990, due to the partnership with IBM, the Federal Trade Commission set its eye on Microsoft for possible collusion, marking the beginning of over a decade of legal clashes with the U.S. government.[32] :243–244 Meanwhile, the company was at work on a 32-bit OS, Microsoft Windows NT, which was heavily based on their copy of the OS/2 code. It shipped on July 21, 1993, with a new modular kernel and the Win32 application programming interface (API), making porting from 16-bit (MS-DOS-based) Windows easier. Once Microsoft informed IBM of NT, the OS/2 partnership deteriorated.</p>

					<p>In 1990, Microsoft introduced its office suite, Microsoft Office. The suite bundled separate productivity applications, such as Microsoft Word and Microsoft Excel.[14]:301 On May 22, Microsoft launched Windows 3.0, featuring streamlined user interface graphics and improved protected mode capability for the Intel 386 processor.[34] Both Office and Windows became dominant in their respective areas.[35][36] On July 27, 1994, the U.S. Department of Justice, Antitrust Division filed a Competitive Impact Statement that said, in part: "Beginning in 1988, and continuing until July 15, 1994, Microsoft induced many OEMs to execute anti-competitive "per processor" licenses. Under a per processor license, an OEM pays Microsoft a royalty for each computer it sells containing a particular microprocessor, whether the OEM sells the computer with a Microsoft operating system or a non-Microsoft operating system. In effect, the royalty payment to Microsoft when no Microsoft product is being used acts as a penalty, or tax, on the OEM's use of a competing PC operating system. Since 1988, Microsoft's use of per processor licenses has increased."</p>

					<h3>Expansion</h3>

					<p>Following Bill Gates's internal "Internet Tidal Wave memo" on May 26, 1995, Microsoft began to redefine its offerings and expand its product line into computer networking and the World Wide Web.[38] The company released Windows 95 on August 24, 1995, featuring pre-emptive multitasking, a completely new user interface with a novel start button, and 32-bit compatibility; similar to NT, it provided the Win32 API.[39][40]:20 Windows 95 came bundled with the online service MSN (which was at first intended to be a competitor to the Internet), and (for OEMs) Internet Explorer, a web browser. Internet Explorer was not bundled with the retail Windows 95 boxes because the boxes were printed before the team finished the web browser, and instead was included in the Windows 95 Plus! pack.[41] Branching out into new markets in 1996, Microsoft and General Electric's NBC unit created a new 24/7 cable news channel, MSNBC.[42] Microsoft created Windows CE 1.0, a new OS designed for devices with low memory and other constraints, such as personal digital assistants.[43] In October 1997, the Justice Department filed a motion in the Federal District Court, stating that Microsoft violated an agreement signed in 1994 and asked the court to stop the bundling of Internet Explorer with Windows.</p>

					<p>On January 13, 2000, Bill Gates handed over the CEO position to Steve Ballmer, an old college friend of Gates and employee of the company since 1980, while creating a new position for himself as Chief Software Architect.[14]:111, 228[18] Various companies including Microsoft formed the Trusted Computing Platform Alliance in October 1999 to (among other things) increase security and protect intellectual property through identifying changes in hardware and software. Critics decried the alliance as a way to enforce indiscriminate restrictions over how consumers use software, and over how computers behave, and as a form of digital rights management: for example the scenario where a computer is not only secured for its owner, but also secured against its owner as well.[44][45] On April 3, 2000, a judgment was handed down in the case of United States v. Microsoft,[46] calling the company an "abusive monopoly."[47] Microsoft later settled with the U.S. Department of Justice in 2004.[30] On October 25, 2001, Microsoft released Windows XP, unifying the mainstream and NT lines of OS under the NT codebase.[48] The company released the Xbox later that year, entering the game console market dominated by Sony and Nintendo.[49] In March 2004 the European Union brought antitrust legal action against the company, citing it abused its dominance with the Windows OS, resulting in a judgment of €497 million ($613 million) and requiring Microsoft to produce new versions of Windows XP without Windows Media Player: Windows XP Home Edition N and Windows XP Professional N.[50][51] In November 2005, the Xbox 360 was released. There were two versions, a no-frills version for $299.99 and a bells-and-whistles version for $399.99.</p>

					<h3>Recent Years</h3>

					<p>Following the release of Windows Phone, Microsoft undertook a gradual rebranding of its product range throughout 2011 and 2012, with the corporation's logos, products, services and websites adopting the principles and concepts of the Metro design language.[67] Microsoft unveiled Windows 8, an operating system designed to power both personal computers and tablet computers, in Taipei in June 2011.[68] A developer preview was released on September 13, which was subsequently replaced by a consumer preview on February 29, 2012 and released to the public in May.[69] The Surface was unveiled on June 18, becoming the first computer in the company's history to have its hardware made by Microsoft.[70][71] On June 25, Microsoft paid US$1.2 billion to buy the social network Yammer.[72] On July 31, they launched the Outlook.com webmail service to compete with Gmail.[73] On September 4, 2012, Microsoft released Windows Server 2012.</p>

					<p>In July 2012, Microsoft sold its 50% stake in MSNBC.com, which it had run as a joint venture with NBC since 1996.[75] On October 1, Microsoft announced its intention to launch a news operation, part of a new-look MSN, with Windows 8 later in the month.[76] On October 26, 2012, Microsoft launched Windows 8 and the Microsoft Surface.[71][77] Three days later, Windows Phone 8 was launched.[78] To cope with the potential for an increase in demand for products and services, Microsoft opened a number of "holiday stores" across the U.S. to complement the increasing number of "bricks-and-mortar" Microsoft Stores that opened in 2012.[79] On March 29, 2013, Microsoft launched a Patent Tracker.</p>
